...
public class ManipulateExercisesCheckboxTest {
    ...
    public void submitFormWithOnlyCheckbox1SelectedFindElementException(){
        ...
        // Assumes checkBox1 is not selected. This is fine if we want to encode preconditions in each test or we could
        // test for preconditions on page directly and have 1 test which fails on precondition failure, and all
